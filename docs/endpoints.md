...
- [/availability/route.ts](/app/app/api/trainer/availability/route.ts) - CRUD endpoint for [TrainerDaySchedule](/app/models/TrainerDaySchedule.ts) entities. The [AvailabilityManager](/app/app/components/AvailabilityManager.tsx) makes requests to this endpoint on submission.
...
- [/health-metrics/](/app/app/api/member/health-metrics/) - Creation, Read and Delete endpoint for [HealthMetric](/app/models/HealthMetric.ts) entities.
