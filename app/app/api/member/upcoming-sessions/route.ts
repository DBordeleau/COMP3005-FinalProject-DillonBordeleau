...
// Gets all upcoming training sessions and enrolled group classes for the logged in member
// Used to populate the "Upcoming Sessions" section on the member dashboard
// Any sessions in the past are not returned
